...
with RceAsyncAndFrpHooks
{
   ...
   export avcframewrk.forms.templating.reactjs.ReactProductEditComponent
   ...
   export avcframewrk.forms.templating.reactjs.ReactElement

   export avcframewrk.forms.templating.reactjs.ReactCtx
