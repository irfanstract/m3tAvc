      ...
      val _C = {
         ...
         object XData {
            ...
            = {
               ({
                  ...
                  = {
                     ...
                     undoRedoFrp.initiallyWith[_Json._MValue ] ({
                        ;
            ...
            object _Json {
               ...
               type _M
               >: avcframewrk.forms.documentstatemgmt.UndoAndRedo.SpecialFpCcOps.gv.forPairOfConstLl.OperatedMdlStateSetCc[_MValue ]
               <: avcframewrk.forms.documentstatemgmt.UndoAndRedo.SpecialFpCcOps.gv.forPairOfConstLl.OperatedMdlStateSetCc[_MValue ]

               type _MValue
               >: ([A] =>> A )[avcalculus.musical.Key._Any ]
               <: ([A] =>> A )[avcalculus.musical.Key._Any ]
         ...
         rce.ReactComponent1.describe((_: Any ) => {
            ...
            = {
               ;
               rce.useEventCallback((item: XData._Json._MValue) => {
                  updateSTo({
                     /* https://github.com/lampepfl/dotty/issues/18768 */
                     val sOps = s.:%&:!!
                     import sOps.{*, given }
            ...
            rce.describeElement("div", null, (
               ...
               :+ rce.describeElement("button", rce.newHtmlButtonAttribs.setOnClick(_ => pushArbitraryEdit(() ) ) , "edit" )
            ) : _* )
         })
      }
      rce.describeElement(_C , null )
