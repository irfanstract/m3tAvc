...
object cxdByDomFsDirAndJsonIter {
   ...
   = {
      ...
      new %%^(
         ...
         emva = emvaImpl ,
         _PayloadedHistJsonSer = _PayloadedHistJsonSer ,
   ...
   class %%^
      ...
      (
         ...
         private[rceBasedUiTemplates]
         val mainEditingUi
         // : (value: _PayloadedHistJsonSer._MValue, stack: _PayloadedHistJsonSer._M ) => rce.ReactElement
         : (ctx: (
            `%%^_Impl` {
               val emva: {
                  type MdlValue
   ...
   AnyRef
   {
      ...
      val 
      initialMdlValue
      : DummyImplicit ?=> _PayloadedHistJsonSer._MValue

      private[rceBasedUiTemplates]
      val mainEditingUi
      // : (value: emva.MdlValue, stack: _PayloadedHistJsonSer._M ) => rce.ReactElement
      : (ctx : this.type) ?=> (
         value: emva.MdlValue ,
         stack: undoRedoFrp.OperatedMdlStateSetCc[emva.MdlValue ] ,
         ss: ctx._CImplHooks.%! ,
      ...
      object _PayloadedHist {
         ...
         export this1.{_PayloadedHistJsonSer as _Json }
      ...
      object _CImplHooks {
            ...
            ()
         {
            ...
            = {
               ...
               _PayloadedHist.useUpstreamSnapshot()
            }
