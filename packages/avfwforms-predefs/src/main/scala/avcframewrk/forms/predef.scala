...
export avcframewrk.forms.specialMath.CSingleton

export avcframewrk.forms.specialMath.InstanceOf
...
type LexicalAsynchronicity
   = avcframewrk.forms.specialMath.LexicalImperativeSynchronicityGiven.ByCcBeingAny
