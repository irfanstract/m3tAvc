...
object W3SR {
   ...
   object MStreamUi {
      ...
      = {
         ...
         slinkify.publicly.ecl[(Unit, SrEdRestInspectOnly )] ((
            //
   ...
   extends
   SrStarts
   with SrEdRestInspectOnly

   trait SrEdRestInspectOnly
      // [+Proc <: Singleton ](protected val impl: Proc )
   extends
   AnyRef
   { this : SrStarts =>
      ...
      // export peer.triStateAnim
      def triStateAnim = peer.triStateAnim
      // export peer.fullLengthBlobAnim
      def fullLengthBlobAnim = peer.fullLengthBlobAnim
