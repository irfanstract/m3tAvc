...
object clauseInterweavedActionItemDispatcherImpl
{
   ...
   object Main {
      ...
      //       // valueOf[Unit ] ==: (identity[manager.ItsRfdXValue[e.type] ] ) =:
      //       {
      ...
      //          match { case rF => ; rF : asyncness.MainByReturnValue[responseFmt.XValue ] }
      //          match { case rF => {
      //             summon[(
      ...
      //                manager.ItsRfdXValue[e.type]
      //             )]
      //             .liftCo[[A] =>> asyncness.MainByReturnValue[A] ]
      //             .apply(rF )
      //          } }
      //          match { case rF => ; rF : asyncness.MainByReturnValue[manager.ItsRfdXValue[e.type] ] }
