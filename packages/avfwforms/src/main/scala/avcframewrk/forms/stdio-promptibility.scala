...
= {
   ...
   Question.XSummedAllViewImpl.apply({ EmeHeadlinedEnumQuestionImpl(messageImpl = "hello", responseFormatImpl = Question.ResponseFormat.ofUnit ) })

   // summon[Promptibility.XDispatcher.ByNoSpec ]
   // .apply({ EmeHeadlinedEnumQuestionImpl(messageImpl = "hello", responseFormatImpl = Question.ResponseFormat.ofUnit ) })
...
object EmeHeadlinedEnumQuestionImpl {
   ...
   given [ActualEmeImpl <: EmeHeadlinedEnumQuestionImpl ]
   // : Question.HeadlineExtractor[ActualEmeImpl ]
   : HeadlineInspectiveExtensiveOps[ActualEmeImpl ]
   with {
   ...
   given given_AcceptableResponseFormatDescExtractor_ActualEmeImpl[ActualEmeImpl <: EmeHeadlinedEnumQuestionImpl ]
