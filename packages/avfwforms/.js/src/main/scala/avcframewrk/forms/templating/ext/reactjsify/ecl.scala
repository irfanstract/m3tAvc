               ...
               '{
                  ...
                  ({
                     ...
                     (
                        ...
                        observativity: eclReactObservingHooksImpl.EOBSM._Any ,
                     ) ?=>
                        ${e }
                  })(using
                     //
      ...
      = {
         ...
         case _ *: exprTr *: _ =>
            ...
            = {
               ...
               .symRefTryCollect(exprTr )(assumedOwner )
               .get
            }
            ;
      ...
      = {
         ...
         .pipeLooseSelf({
            ...
            case e @ '{ ${mainQuery } : (mainQueryExprReturnTpe) } => {
               ...
               = mainQuery.renderReactJsDependenciesArray(assumedOwner = assumedOwner )
               ...
               '{
                   ...
                   * 
                   */
                  ({ "no B-reduction!" ; compiletime.summonInline[EclReactHookSummonable.ToUseCachedValue._ForR[mainQueryExprReturnTpe & R ] ] } )
