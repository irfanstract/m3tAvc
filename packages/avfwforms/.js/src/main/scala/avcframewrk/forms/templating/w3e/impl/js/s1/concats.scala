      ...
      extension (src: laminar.api.L.Signal[ConcatArtDat.XItemSeqOps[Article] ] ) {
         ...
         = {
            ...
            = {
               ...
               match { case s: SpawnabilityAndReconciliabilityNoArg[t1, t2, t3] => val tc = (new AnyRef).asInstanceOf[{ type Reconcilee = t2 }] ; (tc, s ) : (tc.type, Any ) { val _2 : SpawnabilityAndReconciliabilityNoArg[t1, _1.Reconcilee, t3 ] } }
            }
