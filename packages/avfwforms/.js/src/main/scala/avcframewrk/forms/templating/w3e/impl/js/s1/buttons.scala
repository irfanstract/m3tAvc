   ...
   with w3e.pre.Buttons
{
   ...
   = {
      ...
      avfwnk1.XEAndStateBag(ec = { laminar.api.L.button })
      {
         ;
         ...
         val enablednessPipe
         = {
            avcframewrk.evm.AsyncAlgebraicItemStream.newReroutiblePipe[0 | 0.5 | 1 ]()
         }
         ...
         // val optionalCallbackSelPipe
         // = {
         //    avcframewrk.evm.AsyncAlgebraicItemStream.newReroutiblePipe[Option[Nothing] ]()
         // }
