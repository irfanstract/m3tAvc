   ...
   AnyRef
{
   ...
   : AnyRef with {
      ...
      abstract
      class XEAndStateBag[+NativeE <: org.scalajs.dom.HTMLElement] (ec: com.raquo.laminar.tags.HtmlTag[NativeE] )
      {
         ;
