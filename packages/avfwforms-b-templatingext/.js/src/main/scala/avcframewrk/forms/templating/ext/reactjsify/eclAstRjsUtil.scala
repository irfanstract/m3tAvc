                  ...
                  .pipeLooseSelf(s => {
                     if debugMode then
                        ...
                        .map({
                              ...
                              .pipeLooseSelf(e => {
                                 ...
                                 .pipeLooseSelf({
                                    ...
                                    case toSRef if (!toSRef.isExpr && s.isDefDef ) =>
                                       '{ s"error: a ref to 'def', which does not thisself constitute valid Expr ; most likely requires additional arg-list : ${${Expr(s.fullName ) } } " ; () }
                                    case toSRef =>
                           ...
                           case s => {
                              '{ s"error: cannot establish Expr: ${${Expr(s.fullName ) } } " ; () }
                           }
                        })
                  })
                  .pipeLooseSelf(e => e )
