...
object encodedFormsEDcei
{
   ...
   extends
   EwfTranscodFnc.OfIterativeInputAndIterativeOutput[XRRW["r"], XedfMuuxProperties, XDecoderInstance ]
   {
   ...
   extends
   EwfTranscodFnc.OfImperativeInputAndIterativeOutput[XRRW["w"], XedfMuuxProperties, XDecoderInstance ]
   {
   ...
   extends
   EwfTranscodFnc.OfIterativeInputAndIterativeOutput[BbsdAvFrameIterator, XedfMuuxProperties, XRRW["r"] ]
   {
