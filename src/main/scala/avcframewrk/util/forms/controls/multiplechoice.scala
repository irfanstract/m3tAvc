...
object MultipleChoice {
   ...
   AnyRef with XDescriptor.Ops[Item]
   {
      ...
      require(enforcedArity containsValue(defaultOption.size ) )
      require(enforcedArity containsValue(supposedAllOptions.size ) )
      ...
      object ByIsolatedResolver
      {
         ...
         def apply[
            ...
            implSpawn: (
               [Item]
               =>
               (ctx: Reslv.ByItemAndCc[? >: Item, ? >: [E] =>> CC[E] <: [_] =>> Any ])
               =>
               (
                  AnyRef
         ...
         type XPeerSpawnOptionsArgOps[Item]
            >: MultipleChoice.XDescriptor[Item]
            <: MultipleChoice.XDescriptor[Item]
         
         protected 
         final lazy
         val XPeerSpawnOptionsArgOps
            : MultipleChoice.XDescriptor.type
            = MultipleChoice.XDescriptor
            ...
            )]
            {
               ...
               = {
                  ...
                  val setDescriptor = {
                     ...
                     new MultipleChoice.XDescriptor[Item](
                        //
