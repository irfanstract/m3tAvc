...
//   val v = (Compile / compile).value

//   v
// }
// java.lang.System.getenv()
// envVars := {
//   val m0 = envVars.value
//   println(s"had to add the Node bin dir into PATH for the dev")
//   val m1 = {
//     // TODO
//     m0
//     .map({ case (k, v) => (k.toUpperCase(java.util.Locale.ROOT), v ) })
//     .map({
//       case e @ ("PATH", v) =>
//         e copy(_2 = s"${e._1};C:\\Users\\62857\\X-Dev-Runtimes\\node-v16.16.0-win-x64" )
//       case e =>
//         e
//     })
//   }
...
(bloopInstall) := {
  envVars.value
  println(s"again, had to add the Node bin dir into PATH for the dev")
  (bloopInstall).value
}
